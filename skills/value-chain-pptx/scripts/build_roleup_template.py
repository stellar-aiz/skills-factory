"""One-shot generator: value-chain-pptx の roleup curated template を
...
SRC = os.path.join(SKILL_DIR, "assets", "stellar_aiz", "value-chain-template.pptx")
DST = os.path.join(SKILL_DIR, "assets", "roleup", "value-chain-template.pptx")
