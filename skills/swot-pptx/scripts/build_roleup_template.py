"""One-shot generator: swot-pptx の roleup curated template を
...
SRC = os.path.join(SKILL_DIR, "assets", "stellar_aiz", "swot-template.pptx")
DST = os.path.join(SKILL_DIR, "assets", "roleup", "swot-template.pptx")
